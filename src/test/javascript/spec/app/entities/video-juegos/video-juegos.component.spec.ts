...
import { VideoJuegosComponent } from 'app/entities/video-juegos/video-juegos.component';
...
describe('Component Tests', () => {
  describe('VideoJuegos Management Component', () => {
    let comp: VideoJuegosComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VideoJuegosComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.videoJuegos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
