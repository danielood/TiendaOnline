...
@NgModule({
  imports: [
    ...
    TiendaOnlineSharedModule.forRoot(),
    TiendaOnlineCoreModule,
    TiendaOnlineHomeModule,
    TiendaOnlineAccountModule,
